...
namespace autolink {
    ...
    enum VendorVehicleProperty getPropValueID(int32_t propId)
    {
        ...
        switch(pid) {
            ...
            case EViPropId_N80::DOORSLDWARNABUSE_RL_248:
            {
                return VendorVehicleProperty::DOORSLDWARNABUSE_RL_248;
            }
            case EViPropId_N80::DOORSLDWARNANTIPINCH_RL_248:
            {
                return VendorVehicleProperty::DOORSLDWARNANTIPINCH_RL_248;
            }
            case EViPropId_N80::DOORSLDWARNDISBYWINPOS_RL_248:
            {
                return VendorVehicleProperty::DOORSLDWARNDISBYWINPOS_RL_248;
            }
            case EViPropId_N80::DOORSLDWARNDISBYCHGPORT_RL_248:
            {
                return VendorVehicleProperty::DOORSLDWARNDISBYCHGPORT_RL_248;
            }
            ...
            case EViPropId_N80::DOORSLDWARNABUSE_RR_249:
            {
                return VendorVehicleProperty::DOORSLDWARNABUSE_RR_249;
            }
            case EViPropId_N80::DOORSLDWARNANTIPINCH_RR_249:
            {
                return VendorVehicleProperty::DOORSLDWARNANTIPINCH_RR_249;
            }
            case EViPropId_N80::DOORSLDWARNDISBYWINPOS_RR_249:
            {
                return VendorVehicleProperty::DOORSLDWARNDISBYWINPOS_RR_249;
            }
            case EViPropId_N80::DOORSLDWARNDISBYFUELPORT_RR_249:
            {
                return VendorVehicleProperty::DOORSLDWARNDISBYFUELPORT_RR_249;
            }
