...
| 版本 | 日期 | 变更摘要 |
|------|------|----------|
| **1.2.3** | 2026/5/19 | 1. 执行流水线开头新增版本横幅 `=== property v<VER>  [<steps>] ===`（显示名由 CarPropertyManager 改为工具 ID `property`）<br>2. 横幅打印位置前移至项目解析之前，未知项目错误也能看到当前工具版本与步骤组合 |
| **1.2.2** | 2026/5/14 | 1. `scan` 差异报告完整展示所有新增行 / 删除行 / 修改单元格，去除 10 行 / 20 处的截断与「... 共 N 处」省略提示 |
